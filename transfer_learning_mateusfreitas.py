# -*- coding: utf-8 -*-
"""Transfer_learning_MateusFreitas.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/107VYwTSVIwWkSurl30dMoi0IOc8YSPKm
...
train_dir = os.path.join(PATH, PATH)
#validation_dir = os.path.join(PATH, PATH)
...
train_validation = train_dataset.skip(val_batches // 5)

print('Number of validation batches: %d' % tf.data.experimental.cardinality(train_validation))
...
base_model = tf.keras.applications.MobileNetV2(input_shape=IMG_SHAPE,
                                               include_top=False, #Não trazer camadas densas somente as camadas convulacionadas
                                               weights='imagenet')
